...
//			.antMatchers("/**").permitAll()
			...
			.antMatchers(HttpMethod.GET,"/pedidospool/**").hasAuthority("USER")
			.antMatchers(HttpMethod.POST,"/pedidospool/**").hasAuthority("USER")
			.antMatchers(HttpMethod.PUT,"/pedidospool/**").hasAuthority("USER")
//			.antMatchers(HttpMethod.GET,"/usuario").permitAll()
